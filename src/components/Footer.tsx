        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="lg:col-span-2">
            <h3 className="font-heading text-xl font-bold text-background mb-3">
              <span className="gradient-text">Papaya</span> International
            </h3>
          ...
          <div>
            <h4 className="font-bold text-background mb-3 text-sm">Quick Links</h4>
          ...
          <div>
            <h4 className="font-bold text-background mb-3 text-sm">Legal</h4>
            <ul className="space-y-2 text-sm text-background/60">
